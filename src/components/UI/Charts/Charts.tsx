...
export const Charts = () => {
  ...
  return (
    <StyledCharts>
      ...
      {selectedType === "songs" && (
        <div className="chartList chartListSongs" key="uniqueKey">
          ...
          {chartDataSongs &&
            chartDataSongs.map(
              (
                ...
                <Link key={elem.item.id} to={`/song-details/${elem.item.id}`}>
          ...
          {chartDataAlbums &&
            chartDataAlbums.map(
              (
                ...
                <Link key={elem.item.id} to={`/album-details/${elem.item.id}`}>
                  <div className="chartsElems" key={elem.item.id}>
                    <p className="chartNum">{i + 1}</p>
                    <img
                      className="chartImg"
          ...
          {chartDataArtists &&
            chartDataArtists.map(
              (
                ...
                <Link key={elem.item.id} to={`/artist-details/${elem.item.id}`}>
                  <div className="chartsElems" key={elem.item.id}>
                    <p className="chartNum">{i + 1}</p>
                    <img
                      className="chartImg"
